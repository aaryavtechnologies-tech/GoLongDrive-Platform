...
// express-validator rule arrays for each driver API endpoint.
// Mirrors customer.validator.js — drivers share the same auth rules.
...
const loginDriver = [emailRule, body('password').notEmpty().withMessage('Password is required')];
