...
class ApiClient {
  ...
  static void _logError(int id, String method, Uri url, Object error, StackTrace? stackTrace, int durationMs) {
    ...
    final logMessage = buffer.toString();
    debugPrint(logMessage);
    developer.log(logMessage, name: 'ApiClient', error: error, stackTrace: stackTrace);
  }
  ...
  /// POST request
  static Future<http.Response> post(String endpoint, {dynamic body, Map<String, String>? extraHeaders}) async {
    final id = ++_requestCounter;
    final url = _resolveUri(endpoint);
    final headers = await _getHeaders(extraHeaders: extraHeaders);
  ...
  /// PUT request
  static Future<http.Response> put(String endpoint, {dynamic body, Map<String, String>? extraHeaders}) async {
    final id = ++_requestCounter;
    final url = _resolveUri(endpoint);
    final headers = await _getHeaders(extraHeaders: extraHeaders);
  ...
  /// PATCH request
  static Future<http.Response> patch(String endpoint, {dynamic body, Map<String, String>? extraHeaders}) async {
    final id = ++_requestCounter;
    final url = _resolveUri(endpoint);
    final headers = await _getHeaders(extraHeaders: extraHeaders);
  ...
  /// DELETE request
  static Future<http.Response> delete(String endpoint, {dynamic body, Map<String, String>? extraHeaders}) async {
    final id = ++_requestCounter;
    final url = _resolveUri(endpoint);
    final headers = await _getHeaders(extraHeaders: extraHeaders);
