...
class _SearchResultsScreenState extends State<SearchResultsScreen> {
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${car['category']} • ${car['ac'] ? 'AC' : 'Non-AC'} • ${car['seats']} Seats',
                      ...
                      Row(
                        children: [
                          Icon(
                            car['availableNow'] == true
                                ? Icons.check_circle
                                : Icons.schedule,
                            size: 14,
                            color: car['availableNow'] == true
                                ? AppColors.success
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'We currently do not have any vehicles operating on this route. Please try changing your dates or locations.',
              style: AppTextStyles.body.copyWith(
                color: colors.textSecondary,
                height: 1.5,
              ),
  ...
  Widget _buildErrorState(AppColorPalette colors) {
    return Center(
      child: Padding(
        padding: const EdgeInsets.all(32.0),
        child: Column(
