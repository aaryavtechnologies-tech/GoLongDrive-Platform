...
import { UserPlus, Car, CreditCard, Ban, Activity } from 'lucide-react';
import { format } from 'date-fns';

export function CustomerTimeline({ data, isLoading }: { data?: CustomerTimelineEvent[], isLoading: boolean }) {
