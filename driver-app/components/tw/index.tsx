...
export const TouchableOpacity = React.forwardRef<any, React.ComponentProps<typeof RNTouchableOpacity> & { className?: string }>(
  (props, ref) => {
    // @ts-expect-error
    return useCssElement(RNTouchableOpacity, { ...props, ref }, { className: "style" });
  }
);
